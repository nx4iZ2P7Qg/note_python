...
class InterfacesTest(TestCase):
    ...
    def test_instantiate_vnf(self, mock_call_req):
        ...
        vnflcm_info = {
           ...
           "vnfLcmOpOccId": "NF-INST-8-6ffa8083-6705-49b3-ae54-cbd6265fbe7a"
        ...
        req_data = {
            ...
            'vnfDescriptorId': 'vcpe_vfw_certus_1_0',
            'additionalParam': {
                'sdncontroller': '',
                'NatIpRange': '',
                'm6000_mng_ip': '',
        ...
        response = self.client.post("/api/certusvmanagerdriver/v1/1/vnfs",
    ...
    def test_terminate_vnf(self, mock_call_req):
        ...
        response = self.client.post("/api/certusvmanagerdriver/v1/certusvnfmid/vnfs/2/terminate")
    ...
    def test_query_vnf(self, mock_call_req):
        vnfm_info = {
            ...
            "description": "vnfm",
            "certificateUrl": "",
            "url": "http://192.168.2.124:8080/mano-vnfm",
            "userName": "admin",
            "password": "admin",
            "createTime": "2016-07-06 15:33:18"
        }
        ...
        response = self.client.get("/api/certusvmanagerdriver/v1/19ecbb3a-3242-4fa3-9926-8dfb7ddc29ee/vnfs/88")
    ...
    def test_operation_status(self, mock_call_req):
        ...
        mock_call_req.side_effect = [r1, r2]
        response = self.client.get("/api/certusvmanagerdriver/v1/%s/jobs/%s?responseId=0"
    ...
    def test_grantvnf(self, mock_call_req):
        ...
        response = self.client.put("/api/certusvmanagerdriver/v1/resource/grant",
                                   data=json.dumps(req_data), content_type='application/json')
    ...
    def test_notify(self, mock_call_req):
        ...
        response = self.client.post("/api/certusvmanagerdriver/v1/vnfs/lifecyclechangesnotification",
    ...
    def test_get_vnfpkgs(self, mock_call_req):
        ...
        resp = self.client.get("/api/certusvmanagerdriver/v1/vnfpackages")
